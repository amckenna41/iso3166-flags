...
Unit tests (`tests/test_iso3166_1_flags.py`, `tests/test_flag_metadata.py`) were updated in this PR to account for the 21 non-official exception flags in the synced dataset: arab, asean, cefta, cp, dg, eac, es-ct, es-ga, es-pv, eu, gb-eng, gb-nir, gb-sct, gb-wls, ic, pc, sh-ac, sh-hl, sh-ta, un, xx.
