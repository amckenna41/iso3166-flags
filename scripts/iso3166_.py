...
_records = [
    ...
    Country("Ascension Island", "AC", "ASC", "", "Ascension Island"),
    ...
    Country("Bolivia", "BO", "BOL", "068", "Bolivia"),
    Country("Bonaire, Sint Eustatius and Saba", "BQ", "BES", "535", "Bonaire, Sint Eustatius and Saba"),
    Country("Bonaire, Saint Eustatius and Saba", "BQ", "BES", "535", "Bonaire, Saint Eustatius and Saba"),
    Country("Bosnia and Herzegovina", "BA", "BIH", "070", "Bosnia and Herzegovina"),
    Country("Bosnia Herzegovina", "BA", "BIH", "070", "Bosnia Herzegovina"),
    ...
    Country("British Virgin Islands", "VG", "VGB", "092", "British Virgin Islands"),
    Country("Brunei", "BN", "BRN", "096", "Brunei"),
    ...
    Country("Burma", "MM", "MMR", "104", "Burma"),
    ...
    Country("Canary Islands", "IC", "", "", "Canary Islands"),
    Country("Cape Verde", "CV", "CPV", "132", "Cape Verde"),
    Country("Cabo Verde", "CV", "CPV", "132", "Cabo Verde"),
    Country("Catalonia", "ES-CT", "ESP", "724", "Catalonia"),
    Country("Cayman Islands", "KY", "CYM", "136", "Cayman Islands"),
    Country("Central African Republic", "CF", "CAF", "140", "Central African Republic"),
    Country("Ceuta, Melilla", "EA", "", "", "Ceuta, Melilla"),
    ...
    Country("Clipperton Island", "CP", "", "", "Clipperton Island"),
    Country("Cocos Islands", "CC", "CCK", "166", "Cocos Islands"),
    ...
    Country("Czech Republic", "CZ", "CZE", "203", "Czech Republic"),
    Country("Czechia", "CZ", "CZE", "203", "Czechia"),
    Country("Czechoslovakia", "CS", "", "", "Czechoslovakia"),
    Country("Democratic Republic of the Congo", "CD", "COD", "180", "Democratic Republic of the Congo"),
    Country("Denmark", "DK", "DNK", "208", "Denmark"),
    Country("Diego Garcia", "DG", "", "", "Diego Garcia"),
    ...
    Country("East Timor", "TL", "TLS", "626", "East Timor"),
    ...
    Country("European Union", "EU", "", "", "European Union"),
    Country("Eurozone", "EZ", "", "", "Eurozone"), #exceptional reservation
    Country("Falkland Islands", "FK", "FLK", "238", "Falkland Islands"),
    ...
    Country("Galicia", "ES-GA", "ESP", "724", "Galicia"),
    ...
    Country("Macau", "MO", "MAC", "446", "Macau"),
    ...
    Country("Micronesia", "FM", "FSM", "583", "Micronesia"),
    Country("Moldova, Republic of", "MD", "MDA", "498", "Moldova, Republic of"),
    Country("Moldova", "MD", "MDA", "498", "Moldova"),
    ...
    Country("Netherlands Antilles", "AN", "", "", "Netherlands Antilles"),
    Country("Neutral Zone", "NT", "", "", "Neutral Zone"),
    ...
    Country("North Korea", "KP", "PRK", "408", "North Korea",),
    ...
    Country("Palestine", "PS", "PSE", "275", "Palestine"),
    ...
    Country("Republic of the Congo", "CG", "COG", "178", "Republic of the Congo"),
    Country("Republic of Ireland", "IE", "IRL", "372", "Republic of Ireland"),
    Country("Réunion", "RE", "REU", "638", "Réunion"),
    Country("Romania", "RO", "ROU", "642", "Romania"),
    Country("Russia", "RU", "RUS", "643", "Russia"),
    ...
    Country("South Korea", "KR", "KOR", "410", "South Korea"),
    ...
    Country("Tanzania", "TZ", "TZA", "834", "Tanzania"),
    ...
    Country("Tristan da Cunha", "TA", "TAA", "", "Tristan da Cunha",),
    ...
    Country("United Kingdom", "GB", "GBR", "826", "United Kingdom"),
    Country("UK", "GB", "GBR", "826", "UK"),
    Country("Northern Ireland", "GB-NIR", "GBR", "826", "Northern Ireland"),
    Country("England", "GB-ENG", "GBR", "826", "England"),
    Country("Wales", "GB-WLS", "GBR", "826", "Wales"),
    ...
    Country("US Virgin Islands", "VI", "VIR", "850", "US Virgin Islands"),
    Country("USSR", "SU", "", "", "USSR"), #exceptional reservation
    Country("Unknown States", "XX", "", "", "Unknown States"),
    Country("Uruguay", "UY", "URY", "858", "Uruguay"),
    Country("Uzbekistan", "UZ", "UZB", "860", "Uzbekistan"),
    Country("Vanuatu", "VU", "VUT", "548", "Vanuatu"),
    Country("Vatican City", "VA", "VAT", "336", "Vatican City"),
    Country("Venezuela, Bolivarian Republic of", "VE", "VEN", "862", "Venezuela, Bolivarian Republic of"),
    Country("Venezuela", "VE", "VEN", "862", "Venezuela"),
    Country("Vietnam", "VN", "VNM", "704", "Vietnam"),
    ...
    Country("Flags of Moroccan provinces claimed by Western Sahara", "EH", "ESH", "732", "Flags of Moroccan provinces claimed by Western Sahara"),
    Country("Yemen", "YE", "YEM", "887", "Yemen"),
    Country("Yugoslavia", "YU", "", "", "Yugoslavia"),
    Country("Zaire", "ZR", "", "", "Zaire"),
...
def _build_index(idx: int) -> Dict[str, Country]:
    ...
    return dict((r[idx].title(), r) for r in _records)
...
#get object of all countries and respective codes
