...
def create_iso3166_1_css(country_input_folder: str="iso3166-1-icons", export_css_filepath: str="iso3166-1-icons.css") -> None:
    """
    Create custom CSS file for all ISO 3166-1 flag icons. Each flag will have its own custom CSS 
    ...
    Parameters
    ==========
    :country_input_folder: string (default="iso3166-1-icons")
        folder where ISO 3166-1 flags are stored on repo.
    :export_css_filepath: str (default="iso3166-1-icons.css")
...
def create_iso3166_2_css(country_input_folder: str="iso3166-2-icons", export_css_filepath: str="iso3166-2-icons.css") -> None:
    """
    Create custom CSS file for all ISO 3166-2 flag icons. Each subdivision flag will have its own custom 
    ...
    Parameters
    ==========
    :country_input_folder: string (default="iso3166-2-icons")
        filename of folder for where ISO 3166-2 flags are stored.
    :export_css_filepath: str (default="iso3166-2-icons.css")
...
if __name__ == '__main__':
    ...
    parser.add_argument('-iso3166_1_country_input_folder', '--iso3166_1_country_input_folder', type=str, required=False, default="iso3166-1-icons", 
        help='Input folder of ISO 3166-1 flag icons.')
    parser.add_argument('-iso3166_2_country_input_folder', '--iso3166_2_country_input_folder', type=str, required=False, default="iso3166-2-icons", 
        help='Input folder of ISO 3166-2 flag icons.')
    parser.add_argument('-export_iso3166_1_css_filepath', '--export_iso3166_1_css_filepath', type=str, required=False, default="iso3166-1-icons-test.css", 
        help='Export filepath for generated ISO 3166-1 CSS file.')
    parser.add_argument('-export_iso3166_2_css_filepath', '--export_iso3166_2_css_filepath', type=str, required=False, default="iso3166-2-icons-test.css", 
